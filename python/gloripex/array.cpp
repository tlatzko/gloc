...
namespace gloripex {
  ...
  ArrayConverter<Array<complex64, 1> > array_complex64_1_converter;
  ArrayConverter<Array<complex64, 2> > array_complex64_2_converter;
  ArrayConverter<Array<complex64, 3> > array_complex64_3_converter;

  ArrayConverter<Array<complex128, 1> > array_complex128_1_converter;
  ArrayConverter<Array<complex128, 2> > array_complex128_2_converter;
  ArrayConverter<Array<complex128, 3> > array_complex128_3_converter;
}
